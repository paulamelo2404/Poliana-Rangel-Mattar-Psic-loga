...
const Hero = ({ 
  ...
  return (
    <section 
      id="inicio" 
      className="relative min-h-screen w-full overflow-x-hidden bg-white pt-24 lg:pt-28"
    >
      ...
      {/* Container principal */}
      <div className="container relative min-h-screen flex items-center py-10 lg:py-0">
      ...
      >
        <a href="#welcome" className="flex flex-col items-center gap-1 sm:gap-2 text-gray-400 hover:text-gray-600 transition-colors">
